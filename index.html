...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .c-green-dark  { color:#16A34A; }
  .c-gold        { color:#FCA5A5; }
  .c-orange      { color:#FB923C; }
  .c-orange-dark { color:#C2410C; }
  .c-red         { color:#EF4444; }
...
<div class="header">
  <div class="header-title">
    ...
    <p style="color:var(--white)">Agosto 2026</p>
  </div>
...
<div class="nav">
  ...
  <button class="nav-btn" onclick="showPanel('comparativo',this);setTimeout(()=>{if(window._compChartDraw)window._compChartDraw();},50)" style="background:rgba(232,0,45,0.1);border:1px solid rgba(232,0,45,0.3)">📊 Ago 25 vs 26</button>
...
// ── ANDINA Agosto 2026 ──
// [sol, rec, %Quiebre, %Capacidad, %DifADM, %DifPrecio, %Retorno, %Otros]
const ANDINA_RAW_ORIG = {
  TOTTUS: {
    'Gaseosas':   [195872, 166680,  6.49, 2.10, 0.00,  0.12,  5.85, 0.01],
    'Aguas':      [ 49012,  42771,  3.16, 1.94, 0.00,  1.78,  5.51, 0.08],
    'Jugos':      [ 22476,  20277,  2.23, 2.44, 0.00,  0.00,  5.01, 0.00],
    'Isotónicos': [  6723,   5994,  5.01, 2.68, 0.00,  0.00,  3.27, 0.00],
    'Energética': [ 17015,  15543,  1.52, 1.50, 0.00,  0.00,  5.25, 0.00],
  },
  CENCOSUD: {
    'Gaseosas':   [705588, 647324,  3.96, 1.39, 0.00,  0.46,  1.81, 0.01],
    'Aguas':      [265767, 247454,  2.69, 1.78, 0.00,  0.00,  1.91, 0.10],
    'Jugos':      [ 75411,  70161,  1.68, 2.29, 0.01,  0.02,  2.12, 0.01],
    'Isotónicos': [ 16680,  12757, 11.04, 2.00, 0.00,  7.50,  2.61, 0.00],
    'Energética': [ 55057,  49801,  1.53, 5.98, 0.00,  0.00,  1.55, 0.01],
  },
  SMU: {
    'Gaseosas':   [613360, 552593,  3.94, 1.54, 0.01,  0.68,  2.89, 0.01],
    'Aguas':      [118464, 106329,  4.77, 1.83, 0.14,  0.00,  2.65, 0.03],
    'Jugos':      [ 81262,  67555,  9.91, 1.58, 0.02,  0.12,  4.09, 0.02],
    'Isotónicos': [ 24378,  21761,  3.70, 1.92, 0.00,  0.00,  4.11, 0.02],
    'Energética': [ 38586,  36489,  0.80, 1.54, 0.00,  0.00,  2.31, 0.01],
  },
  WALMART: {
    'Gaseosas':   [1038300, 925756,  2.16, 2.27, 0.00,  2.31,  2.80, 0.06],
    'Aguas':      [304622, 264434,  2.95, 3.08, 0.15,  1.02,  4.62, 0.15],
    'Jugos':      [178688, 163066,  1.80, 3.26, 0.01,  0.01,  2.36, 0.11],
    'Isotónicos': [ 44854,  40469,  1.08, 3.05, 0.02,  1.58,  2.54, 0.05],
    'Energética': [ 66445,  61056,  0.83, 3.38, 0.00,  0.00,  2.44, 0.10],
  },
};
...
const EMBONOR_RAW = {
  TOTTUS: {
    'Gaseosas':   [ 50609,  44026,  4.30, 1.80,  4.30, 1.40, 0.50, 0.70],
    'Aguas':      [ 12919,  11653,  2.60, 1.80,  3.30, 1.30, 0.50, 0.30],
    'Jugos':      [  9267,   7834,  4.40, 0.10,  8.60, 1.40, 0.60, 0.30],
    'Isotónicos': [  2441,   2075,  8.10, 3.30,  3.30, 0.00, 0.00, 0.30],
    'Energética': [  1200,   1172,  0.00, 0.00,  2.00, 0.00, 0.10, 0.60],
  },
  CENCOSUD: {
    'Gaseosas':   [309138, 279445,  2.10, 0.40,  2.20, 2.80, 0.20, 1.30],
    'Aguas':      [110463,  98000,  1.90, 0.90,  4.70, 1.70, 0.30, 1.10],
    'Jugos':      [ 47020,  40193,  5.10, 0.50,  5.80, 1.00, 0.20, 1.20],
    'Isotónicos': [ 10288,   8666,  2.30, 2.20,  6.00, 0.70, 0.30, 3.40],
    'Energética': [  9445,   9107,  0.00, 0.00,  1.90, 0.10, 0.10, 1.00],
  },
  SMU: {
    'Gaseosas':   [376393, 334835,  2.10, 1.72,  3.65, 0.60, 0.64, 0.66],
    'Aguas':      [ 70753,  59162,  3.66, 0.00, 10.52, 0.00, 0.36, 0.37],
    'Jugos':      [ 74687,  54320,  6.00, 0.56, 15.84, 2.73, 0.42, 0.39],
    'Isotónicos': [ 22176,  15994,  4.62, 0.00, 20.41, 0.00, 0.50, 0.54],
    'Energética': [  6504,   6201,  0.00, 0.00,  2.14, 0.00, 0.37, 0.72],
  },
  WALMART: {
    'Gaseosas':   [474244, 419888,  1.08, 0.41,  2.89, 3.56, 0.74, 1.21],
    'Aguas':      [129292, 114279,  2.84, 0.00,  2.87, 1.75, 1.18, 1.14],
    'Jugos':      [104091,  88588,  5.11, 4.72,  3.81, 0.27, 0.45, 1.08],
    'Isotónicos': [ 31474,  26332,  6.33, 0.00,  4.83, 1.13, 1.38, 1.06],
    'Energética': [  9065,   8457,  0.02, 0.00,  2.84, 0.43, 0.51, 1.43],
  },
};
...
const CAUSES = [
  ...
  { key:'Eliminado', cls:'c-eliminado', color:'#CC80FF' },
  { key:'No Ident.', cls:'c-noid',      color:'#AAA'    },
  { key:'Capacidad', cls:'c-capacidad', color:'#F5A623' },
  { key:'Otros',     cls:'c-otros',     color:'#607090' },
];
const CAUSE_LABEL = {
...
// ─── COMPARATIVO DATA ─────────────────────────────────────────────────────────
// D25 — Agosto 2025, extraído de TOTAL_CHILE_2025.xlsx
const D25 = {
  CHILE:    { TOTAL:0.8658 },
  ANDINA:   { TOTAL:0.8818 },
  EMBONOR:  { TOTAL:0.8326 },
  TOTTUS:   { TOTAL:0.8582, ANDINA:0.8596, EMBONOR:0.8520 },
  CENCOSUD: { TOTAL:0.9028, ANDINA:0.9150, EMBONOR:0.8747 },
  SMU:      { TOTAL:0.8538, ANDINA:0.8609, EMBONOR:0.8409 },
  WALMART:  { TOTAL:0.8497, ANDINA:0.8725, EMBONOR:0.8065 },
};
const D26 = {
  // Agosto 2026 — calculados desde datos reales
  CHILE:    { TOTAL:0.8907 },
  ANDINA:   { TOTAL:0.8978 },
  EMBONOR:  { TOTAL:0.8758 },
  TOTTUS:   { TOTAL:0.8653, ANDINA:0.8632, EMBONOR:0.8734 },
  CENCOSUD: { TOTAL:0.9116, ANDINA:0.9186, EMBONOR:0.8953 },
  SMU:      { TOTAL:0.8799, ANDINA:0.8958, EMBONOR:0.8547 },
  WALMART:  { TOTAL:0.8871, ANDINA:0.8909, EMBONOR:0.8789 },
};

// ─── EVOLUCIÓN DATA ───────────────────────────────────────────────────────────
// DATA: sol/rec mensuales para YTD correcto
const EVO_DATA = {
  CHILE:   {
    sol2025:[6111318,6037159,6772349,6051094,5329658,4742340,4848973,6015914,6301720,6758869,6688919,7703950],
    rec2025:[5212616,5226711,5939398,5236563,4697969,4133420,4348970,5208492,5438669,5700137,5771440,6832413],
    sol2026:[7705186,6741510,6989778,6078747,5734921,4035586,6487238,5780029], rec2026:[6318085,5903506,6177576,5306432,4909306,3474329,5477060,5148497],
    y2026:[0.820,0.8757,0.8838,0.8729,0.8560,0.8609,0.8443,0.8907]
  },
  ANDINA:  {
    sol2025:[3629807,3580887,4528328,3955907,3593653,3003493,3030156,4055184,4100441,4546555,4677913,4955984],
    rec2025:[3170311,3114137,4021644,3468143,3171230,2631062,2724606,3575968,3533189,3812082,4000677,4406760],
    sol2026:[4745602,4154727,4770962,4128738,3792415,1923924,4386793,3918560], rec2026:[3981333,3629647,4228880,3655587,3317949,1708360,3738132,3518270],
    y2026:[0.839,0.8736,0.8864,0.8854,0.8749,0.8880,0.8521,0.8978]
  },
  EMBONOR: {
    sol2025:[2481511,2456272,2244021,2095187,1736005,1738847,1818817,1960730,2201279,2212314,2011006,2747966],
    rec2025:[2042305,2112574,1917754,1768420,1526739,1502358,1624364,1632524,1905480,1888055,1770763,2425653],
    sol2026:[2959584,2586783,2218816,1950009,1942506,2111662,2100445,1861469], rec2026:[2336752,2273859,1948696,1650845,1591357,1765969,1738928,1630227],
    y2026:[0.790,0.879,0.8783,0.8466,0.8192,0.8363,0.8279,0.8758]
  },
  TOTTUS:  {
    sol2025:[419835,366825,381538,338504,376942,350958,371005,357423,460525,481632,470734,574710],
    rec2025:[322977,302643,328264,281774,311469,284084,310363,306756,374694,388787,387577,502768],
    sol2026:[null], rec2026:[null],
    y2026:[0.815,0.8768,0.8565,0.8724,0.8434,0.8896,0.8297,0.8653]
  },
  CENCOSUD:{
    sol2025:[1799181,1754011,2016402,1694033,1591847,1357727,1484263,1681994,1710775,1872385,1745969,2482516],
    rec2025:[1607510,1544999,1726462,1518354,1432849,1227162,1399892,1518478,1525277,1666677,1560648,2194099],
    sol2026:[null], rec2026:[null],
    y2026:[0.856,0.9035,0.8686,0.8839,0.8740,0.8637,0.8579,0.9116]
  },
  SMU:     {
    sol2025:[1338552,1317392,1546331,1244610,1075378,838139,1076617,1108804,1275032,1489256,1545633,1509601],
    rec2025:[1194908,1177308,1393334,1102745,971776,707044,923284,946705,1095205,1264783,1311806,1334459],
    sol2026:[null], rec2026:[null],
    y2026:[0.816,0.8267,0.8794,0.8725,0.8480,0.8220,0.8576,0.8799]
  },
  WALMART: {
    sol2025:[2553748,2598930,2828076,2773945,2285489,2195514,1917088,2867692,2855387,2915595,2926582,3137121],
    rec2025:[2087218,2201760,2491337,2333690,1981874,1915128,1715430,2436551,2443491,2379889,2511408,2801087],
    sol2026:[null], rec2026:[null],
    y2026:[0.803,0.8929,0.9011,0.8657,0.8502,0.8855,0.8311,0.8871]
  },
};
...
// ─── Redondeo consistente: FR + causas deben sumar exactamente 100,0% en pantalla ───
// Cada % se muestra redondeado a 1 decimal por separado, lo que puede hacer que la
// suma visual no cierre en 100%. Para evitarlo, la categoría "Otros" (índice 7,
// que ya es un cajón de cierre matemático) absorbe el resto del redondeo SOLO
// para fines de visualización — no cambia los cálculos internos.
const tenths = v => Math.round(v * 1000); // fracción (0-1) -> décimas de punto porcentual (89,1% = 891)
function causesTenthsForDisplay(fr, causesArr) {
  const frT = tenths(fr);
  const t = causesArr.map(tenths);
  let sum07 = 0;
  for (let i = 0; i < 7; i++) sum07 += t[i];
  let otrosT = 1000 - frT - sum07;
  if (otrosT < 0) otrosT = 0;
  t[7] = otrosT;
  return t;
}
const fmtTenth = t => (t / 10).toFixed(1).replace('.', ',') + '%';
function colorFR(fr) {
...
function barColor(fr) {
  if (fr>0.901) return '#4ADE80';
  if (fr>0.851) return '#16A34A';
  if (fr>0.801) return '#FB923C';
  if (fr>0.751) return '#C2410C';
  if (fr>0.701) return '#EF4444';
  return '#7F1D1D';
}

function aggData(data, chains, cats) {
  let sol=0, rec=0, causes=new Array(8).fill(0);
  chains.forEach(ch => {
    cats.forEach(cat => {
...
function adjustCauses(causePcts, noFR) {
  ...
  adj[7] = 0;
  const sum = adj.slice(0,7).reduce((a,b) => a+b, 0);
...
function renderTable(data, chain, bottlerName) {
  ...
  CATS.forEach(cat => {
    ...
    const dispT = causesTenthsForDisplay(fr, adjCauses);
    tbody += `<tr>
      <td>${cat}</td>
      ...
      ${visibleIdx.map(i=>{const p=adjCauses[i];const show=i===7?dispT[7]>0:p>0;return `<td class="cp ${show?CAUSES[i].cls:'zero'}">${show?fmtTenth(dispT[i]):'—'}</td>`;}).join('')}
    </tr>`;
  });

  const frTot = pct(totRec, totSol);
  const adjTotCauses = adjustCauses(CAUSES.map((c,i) => pct(totCauses[i]||0, totSol)), 1 - frTot);
  const dispTotT = causesTenthsForDisplay(frTot, adjTotCauses);
  tbody += `<tr class="total-row">
    ...
    ${visibleIdx.map(i=>{const p=adjTotCauses[i];const show=i===7?dispTotT[7]>0:p>0;return `<td class="cp ${show?CAUSES[i].cls:'zero'}">${show?fmtTenth(dispTotT[i]):'—'}</td>`;}).join('')}
  </tr>`;
...
function renderBottlerSummary(data, bottlerName, badgeClass, accentColor) {
  ...
  CHAINS.forEach(ch => {
    const {sol, rec} = aggData(data, [ch], CATS);
    const fr = pct(rec, sol);
  ...
  CATS.forEach(cat => {
    ...
    CHAINS.forEach(ch => {
      ...
      totSol+=sol; totRec+=rec;
      html+=`<td><span class="fr-num" style="font-size:0.88rem">${fmtP(pct(rec,sol))}</span></td>`;
    });
    html+=`<td><span class="fr-num">${fmtP(pct(totRec,totSol))}</span></td></tr>`;
  });
  ...
  CHAINS.forEach(ch => {
    ...
    html+=`<td><span class="fr-num">${fmtP(pct(a.rec,a.sol))}</span></td>`;
  });
  html+=`<td><span class="fr-num">${fmtP(frTot)}</span></td></tr></tbody></table></div>`;
  ...
  CHAINS.forEach(ch => {
    ...
    const dispT = causesTenthsForDisplay(fr, adj);
    html += `<tr>
      <td>${ch}</td>
      <td>${fmtN(d.sol)}</td><td>${fmtN(d.rec)}</td>
      <td><span class="fr-num" style="font-size:0.88rem">${fmtP(fr)}</span></td>
      ${visIdx.map(i=>{const p=adj[i];const show=i===7?dispT[7]>0:p>0;return `<td class="cp ${show?CAUSES[i].cls:'zero'}">${show?fmtTenth(dispT[i]):'—'}</td>`;}).join('')}
    </tr>`;
  });
  ...
  const dispTotT = causesTenthsForDisplay(frTot, adjTot);

  html += `<tr class="total-row">
    <td>TOTAL ${bottlerName.toUpperCase()}</td>
    <td>${fmtN(tot.sol)}</td><td>${fmtN(tot.rec)}</td>
    <td><span class="fr-num">${fmtP(frTot)}</span></td>
    ${visIdx.map(i=>{const p=adjTot[i];const show=i===7?dispTotT[7]>0:p>0;return `<td class="cp ${show?CAUSES[i].cls:'zero'}">${show?fmtTenth(dispTotT[i]):'—'}</td>`;}).join('')}
  </tr></tbody></table></div>`;
...
function renderLossTree(fr, causePcts, sol, rec, label, causeLabels) {
  ...
  const dispT = causesTenthsForDisplay(fr, causePcts);
  const treeHtml = CAUSES.map((c, i) => {
    if (lbls[i] === '—') return '';
    const rawP = causePcts[i];
    const show = i === 7 ? dispT[7] > 0 : rawP > 0;
    if (!show) return '';
    const p = dispT[i] / 1000;
    ...
    return `<div style="margin-bottom:10px">
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:3px">
        ...
        <div style="display:flex;gap:12px;align-items:center">
          <span style="font-family:'Barlow Condensed',sans-serif;font-weight:800;font-size:0.95rem;color:${c.color}">${fmtTenth(dispT[i])}</span>
  ...
  return `<div style="background:var(--navy-mid);border:1px solid rgba(255,255,255,0.07);border-radius:12px;padding:18px 20px">
    <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:16px;padding-bottom:14px;border-bottom:1px solid rgba(255,255,255,0.07)">
      <div>
        ...
        <div style="font-family:'Barlow Condensed',sans-serif;font-size:2.2rem;font-weight:900;line-height:1">${fmtP(fr)}</div>
...
function renderResumen() {
  ...
  let html = `<div class="sec-label">Resumen Ejecutivo — Chile Agosto 2026</div>`;
  ...
  CHAINS.forEach(ch => {
    ...
    const causesCh = adjustCauses(avgCausePcts(dA, dE), 1 - frCh);
    const dispT = causesTenthsForDisplay(frCh, causesCh);
    html += `<tr>
      <td>${ch}</td>
      <td>${fmtN(solCh)}</td><td>${fmtN(recCh)}</td>
      <td><span class="fr-num">${fmtP(frCh)}</span></td>
      ${causesCh.map((p,i)=>{const show=i===7?dispT[7]>0:p>0;return `<td class="cp ${show?CAUSES[i].cls:'zero'}">${show?fmtTenth(dispT[i]):'—'}</td>`;}).join('')}
  ...
  const dispTotChile = causesTenthsForDisplay(frChile, causesChile);
  html += `<tr class="total-row">
    <td>TOTAL CHILE</td>
    <td>${fmtN(solChile)}</td><td>${fmtN(recChile)}</td>
    <td><span class="fr-num">${fmtP(frChile)}</span></td>
    ${causesChile.map((p,i)=>{const show=i===7?dispTotChile[7]>0:p>0;return `<td class="cp ${show?CAUSES[i].cls:'zero'}">${show?fmtTenth(dispTotChile[i]):'—'}</td>`;}).join('')}
...
function renderComparativo() {
  ...
  let activeBottler = 'ALL';
  let activeChains  = new Set(ALL_CHAINS);
  ...
  function buildHTML() {
    ...
    cardScope.forEach(([sc,lbl,color,field]) => {
      ...
      h += `<div style="background:var(--navy-mid);border:1px solid rgba(255,255,255,0.07);border-left:3px solid ${color};border-radius:10px;padding:20px 22px">
        ...
        <div style="display:flex;align-items:flex-end;gap:16px;margin-bottom:10px">
          <div>
            <div style="font-size:0.6rem;color:var(--gray-500);text-transform:uppercase;letter-spacing:1px;margin-bottom:2px">AGO 2025</div>
          ...
          <div>
            <div style="font-size:0.6rem;color:var(--gray-500);text-transform:uppercase;letter-spacing:1px;margin-bottom:2px">AGO 2026</div>
    ...
    h += `<canvas id="comp-chart" style="width:100%;max-height:380px"></canvas></div>`;
    return h;
  }
  ...
  function drawChart() {
    ...
    const visChains = ['TOTTUS','CENCOSUD','SMU','WALMART'].filter(c => activeChains.has(c));
    ...
    window._compChart = new Chart(ctx, {
      type: 'bar',
      data: { labels: visChains, datasets },
      options: {
        responsive: true, maintainAspectRatio: true, aspectRatio: 2.6,
        plugins: {
          legend: { position:'top', labels:{ color:'#CCC', font:{family:"'Barlow Condensed',sans-serif",size:13,weight:'700'}, boxWidth:14, padding:24 } },
          tooltip: { backgroundColor:'#0F1D35', borderColor:'rgba(255,255,255,0.1)', borderWidth:1, titleColor:'#FFF', bodyColor:'#CCC',
            callbacks:{ label: ctx => ` ${ctx.dataset.label}: ${ctx.parsed.y.toFixed(1).replace('.', ',')}%` } }
        },
        scales: {
          x: { ticks:{color:'#CCC',font:{family:"'Barlow Condensed',sans-serif",size:14,weight:'700'}}, grid:{color:'rgba(255,255,255,0.04)'} },
          y: { min:55, max:100, ticks:{color:'#AAA',font:{family:"'Barlow Condensed',sans-serif",size:11},callback:v=>v+'%'}, grid:{color:'rgba(255,255,255,0.06)'} }
        },
        animation: { onComplete: function() {
          const chart = window._compChart; if (!chart) return;
          ...
          chart.data.datasets.forEach((ds, i) => {
            ...
            meta.data.forEach((bar, j) => {
              const val = ds.data[j]; if (val == null) return;
              ctx2.fillStyle = ds.label.includes('2026') ? '#FFFFFF' : 'rgba(255,255,255,0.55)';
              ctx2.fillText(val.toFixed(1).replace('.', ',')+'%', bar.x, bar.y - 8);
            });
          });
          ctx2.restore();
        }}
  ...
  window.compSetBottler = function(val) { activeBottler = val; refresh(); };
  window.compToggleChain = function(ch) {
    if (activeChains.has(ch)) { if (activeChains.size > 1) activeChains.delete(ch); }
    else activeChains.add(ch);
    refresh();
  };
...
function buildEvolucion() {
  ...
  const MESES_2026 = ['Ene','Feb','Mar','Abr','May','Jun','Jul','Ago'];
  ...
  function ytdFR(key, year, upToIdx) {
    const solArr = EVO_DATA[key]['sol'+year], recArr = EVO_DATA[key]['rec'+year];
    let totalSol=0, totalRec=0;
  ...
  function buildFilters() {
    const el = document.getElementById('evo-filters'); if (!el) return;
    let h = '<div style="display:flex;align-items:center;gap:8px"><span style="font-size:0.65rem;font-weight:700;letter-spacing:2px;text-transform:uppercase;color:#555">Vista</span>';
    [['CHILE','Total Chile','#E8002D'],['ANDINA','Andina','#0057A8'],['EMBONOR','Embonor','#22C55E']].forEach(([v,l,c])=>{
      h+='<button onclick="evoTogBottler(\''+v+'\')" style="'+btnStyle(activeBottlers.has(v),c)+'">'+l+'</button>';
    });
    h+='</div><div style="display:flex;align-items:center;gap:8px"><span style="font-size:0.65rem;font-weight:700;letter-spacing:2px;text-transform:uppercase;color:#555">Cadena</span>';
    [['TOTTUS','Tottus','#22C55E'],['CENCOSUD','Cencosud','#3B82F6'],['SMU','SMU','#EF4444'],['WALMART','Walmart','#F97316']].forEach(([v,l,c])=>{
  ...
  function buildDatasets() {
    ...
    function addSeries(key, col, lbl) {
      const d25 = EVO_DATA[key].sol2025.map((sol,i) => {
        const rec = EVO_DATA[key].rec2025[i];
        return sol>0 ? +((rec/sol)*100).toFixed(2) : null;
      });
      const d26 = EVO_DATA[key].y2026.map(v => +(v*100).toFixed(2));
      ds.push({ label:lbl+' 2025', data:d25.concat(new Array(d26.length).fill(null)),
        borderColor:col, borderWidth:2, borderDash:[6,4], pointRadius:3, pointHoverRadius:6, tension:0.3, fill:false });
      ds.push({ label:lbl+' 2026', data:new Array(12).fill(null).concat(d26),
        borderColor:col, borderWidth:3, pointRadius:7, pointHoverRadius:9,
        pointBackgroundColor:col, pointBorderColor:'#000', pointBorderWidth:2, tension:0.3, fill:false });
    }
    activeBottlers.forEach(k => addSeries(k, BOTTLER_COLORS[k], ALL_LABELS[k]));
    activeChains.forEach(k => addSeries(k, CHAIN_COLORS[k], ALL_LABELS[k]));
    return ds;
  }

  function buildStatsCards() {
    const el = document.getElementById('evo-stats'); if (!el) return;
    const keys = Array.from(activeBottlers).concat(Array.from(activeChains));
    if (!keys.length) { el.innerHTML=''; return; }
    const lastIdx26 = EVO_DATA['CHILE'].y2026.length - 1;
    const mesLabel  = MESES_2026[lastIdx26];
    el.innerHTML = keys.map(k => {
      const ytd25 = ytdFR(k, '2025', lastIdx26);
      let ytd26;
      if (EVO_DATA[k].sol2026 && EVO_DATA[k].sol2026[0] && EVO_DATA[k].rec2026 && EVO_DATA[k].rec2026[0]) {
        ytd26 = ytdFR(k, '2026', lastIdx26);
      } else {
        ytd26 = EVO_DATA[k].y2026[lastIdx26];
      }
      const dif = ytd26 - ytd25;
      const dc = dif>=0?'#22C55E':'#EF4444';
      const col = ALL_COLORS[k];
      return '<div style="background:#111;border:1px solid rgba(255,255,255,0.07);border-left:3px solid '+col+';border-radius:10px;padding:14px 16px">'
        ...
        +'<div style="font-family:\'Barlow Condensed\',sans-serif;font-weight:900;font-size:1.5rem;color:#888">'+(ytd25*100).toFixed(1).replace('.', ',')+'%</div></div>'
        ...
        +'<div style="font-family:\'Barlow Condensed\',sans-serif;font-weight:900;font-size:1.5rem;color:#fff">'+(ytd26*100).toFixed(1).replace('.', ',')+'%</div></div>'
        +'</div>'
        +'<div style="font-family:\'Barlow Condensed\',sans-serif;font-size:1rem;font-weight:900;color:'+dc+';margin-top:4px">'+(dif>=0?'+':'')+(dif*100).toFixed(1).replace('.', ',')+'pp YTD '+mesLabel+' 25 vs 26</div>'
        +'</div>';
    }).join('');
  }

  function doRender() {
    const canvas = document.getElementById('evo-chart'); if (!canvas) return;
    const xLabels = MESES_2025.map(m=>m+' 25').concat(MESES_2026.map(m=>m+' 26'));
    if (chartInst) { chartInst.destroy(); chartInst=null; }
    chartInst = new Chart(canvas, {
      type:'line',
      data:{ labels:xLabels, datasets:buildDatasets() },
      options:{
        responsive:true, maintainAspectRatio:true, aspectRatio:3.0,
        interaction:{ mode:'index', intersect:false },
        plugins:{
          legend:{ labels:{ color:'#AAA', font:{family:"'Barlow Condensed',sans-serif",size:12,weight:'700'}, boxWidth:18, padding:18 } },
          tooltip:{ backgroundColor:'#0a0a0a', borderColor:'rgba(255,255,255,0.1)', borderWidth:1, titleColor:'#fff', bodyColor:'#ccc',
            callbacks:{ label:c => ' '+c.dataset.label+': '+(c.parsed.y!=null?c.parsed.y.toFixed(1).replace('.', ',')+'%':'—') } }
        },
        scales:{
          x:{ ticks:{color:'#AAA',font:{family:"'Barlow Condensed',sans-serif",size:11,weight:'700'}}, grid:{color:'rgba(255,255,255,0.04)'} },
          y:{ min:60, max:100, ticks:{color:'#AAA',font:{family:"'Barlow Condensed',sans-serif",size:11},callback:v=>v+'%'}, grid:{color:'rgba(255,255,255,0.06)'} }
        }
      },
      plugins:[{
        id:'yrSep',
        afterDraw: function(ch) {
          const cx=ch.ctx, xa=ch.scales.x, ya=ch.scales.y;
          const x11=xa.getPixelForValue(11), x12=xa.getPixelForValue(12);
          const xm=(x11+x12)/2, tp=ch.chartArea.top, bt=ch.chartArea.bottom;
          cx.save();
          ...
          ch.data.datasets.forEach((ds,di) => {
            ...
            const is2026=ds.label&&ds.label.indexOf('2026')!==-1;
            cx.font=is2026?"bold 11px 'Barlow Condensed',sans-serif":"10px 'Barlow Condensed',sans-serif";
            meta.data.forEach((pt,j) => {
              const val=ds.data[j]; if(val==null) return;
              cx.fillStyle=is2026?'#fff':'rgba(255,255,255,0.5)';
              cx.fillText(val.toFixed(1).replace('.', ',')+'%', pt.x, pt.y-(is2026?14:11));
            });
          });
          cx.restore();
        }
  ...
  window.evoTogBottler = v => { if(activeBottlers.has(v)){if(activeBottlers.size>1)activeBottlers.delete(v);}else activeBottlers.add(v); refresh(); };
  window.evoTogChain   = v => { if(activeChains.has(v))activeChains.delete(v);else activeChains.add(v); refresh(); };
...
// ─── F1 RACE ─────────────────────────────────────────────────────────────────
function buildRace() {
  // YTD Agosto 2026: sum(rec ene-ago) / sum(sol ene-ago)
  const andYTD = (3981333+3629647+4228880+3655587+3317949+1708360+3738132+3518270)/(4745602+4154727+4770962+4128738+3792415+1923924+4386793+3918560);
  const embYTD = (2336752+2273859+1948696+1650845+1591357+1765969+1738928+1630227)/(2959584+2586783+2218816+1950009+1942506+2111662+2100445+1861469);

  const RACERS = [
    { id:'andina',  name:'Andina',  code:'AND', fr: andYTD, color:'#3B82F6', glow:'rgba(59,130,246,0.7)' },
    { id:'embonor', name:'Embonor', code:'EMB', fr: embYTD, color:'#22C55E', glow:'rgba(34,197,94,0.7)'  },
  ].sort((a,b) => b.fr - a.fr);

  const panel = document.getElementById('p-race');
  panel.innerHTML = `
  <style>
    #race-wrap { width:100%; height:72vh; background:#000; display:flex; flex-direction:column; font-family:'Barlow Condensed',sans-serif; overflow:hidden; position:relative; }
    #race-wrap::before { content:''; position:absolute; inset:0; z-index:1; pointer-events:none; background:repeating-linear-gradient(0deg,transparent,transparent 3px,rgba(0,0,0,0.09) 3px,rgba(0,0,0,0.09) 4px); }
    .race-header { background:#0a0a0a; border-bottom:3px solid #E8002D; padding:7px 20px; display:flex; align-items:center; gap:14px; flex-shrink:0; z-index:10; }
    ...
    .track-bg { position:absolute; inset:0; background:repeating-linear-gradient(90deg,transparent,transparent 119px,rgba(255,255,255,0.02) 120px),#060606; }
    ...
    #semaforo { position:absolute; left:50%; top:50%; transform:translate(-50%,-50%); z-index:50; display:flex; flex-direction:column; align-items:center; gap:0; background:#111; border:2px solid #333; border-radius:12px; padding:10px 16px; box-shadow:0 0 60px rgba(0,0,0,0.9); transition:opacity .5s; }
    ...
    .sem-light { width:26px; height:26px; border-radius:50%; background:#1a0000; border:2px solid #330000; transition:background .1s, box-shadow .1s; }
  ...
  <div id="race-wrap">
    <div class="race-header">
      ...
      <div class="race-title">Fill Rate Race 2026 — YTD Ago</div>
      <div class="race-period">YTD Agosto 2026</div>
      ...
      <div class="race-track" id="race-track">
        ...
        <div id="semaforo" class="hidden">
          ...
          <div class="sem-lights">
            <div class="sem-light" id="sl1"></div><div class="sem-light" id="sl2"></div>
            <div class="sem-light" id="sl3"></div><div class="sem-light" id="sl4"></div>
  ...
  RACERS.forEach((r, i) => {
    ...
    lbl.innerHTML = '<div class="race-pos-badge" style="background:'+r.color+'">'+(i+1)+'</div>'
      +'<div><div class="race-driver-name">'+r.name+'</div><div class="race-driver-code" style="color:'+r.color+'">'+r.code+'</div></div>';
    labelsEl.appendChild(lbl);

    const lane = document.createElement('div');
    lane.className = 'race-lane'; lane.id = 'lane-'+r.id;
    const trail = document.createElement('div');
    trail.className='car-trail'; trail.id='trail-'+r.id;
    ...
    carWrap.className='car-wrap'; carWrap.id='car-'+r.id;
    carWrap.innerHTML=carSVG(r.color)+'<span class="car-fr-label" id="fr-lbl-'+r.id+'" style="color:'+r.color+'">0.0%</span>';
  ...
  function updateLeaderboard(curFRs) {
    ...
    const lbEl = document.getElementById('lb-rows'); if (!lbEl) return;
    lbEl.innerHTML = sorted.map((r,i) => {
      const gCol = i===0?'#22C55E':'#EF4444';
      const pc = ['p1','p2'][i]||'';
      return '<div class="lb-row"><div class="lb-pos '+pc+'">'+(i+1)+'</div>'
        +'<div class="lb-info"><div class="lb-name">'+r.name+'</div>'
        +'<div class="lb-fr" style="color:'+r.color+'">'+(r.cur*100).toFixed(1).replace('.', ',')+'%</div>'
        +(i===0?'<div class="lb-gap" style="background:'+gCol+'22;color:'+gCol+'">&#9650; Lider</div>'
          :'<div class="lb-gap" style="background:'+gCol+'22;color:'+gCol+'">'+(((sorted[0].cur-r.cur)*100).toFixed(1).replace('.', ','))+'pp</div>')
        +'</div></div>';
    }).join('');
  }

  function runSemaforo(onGo) {
    const sem=document.getElementById('semaforo'); const goEl=document.getElementById('sem-go');
    if (!sem){onGo();return;}
    sem.classList.remove('hidden'); goEl.style.display='none';
    for(let i=1;i<=5;i++){const l=document.getElementById('sl'+i);if(l)l.className='sem-light';}
    let lit=0;
    const interval=setInterval(()=>{
      lit++; const l=document.getElementById('sl'+lit); if(l)l.classList.add('on-red');
      if(lit===5){clearInterval(interval);setTimeout(()=>{
        for(let i=1;i<=5;i++){const ll=document.getElementById('sl'+i);if(ll)ll.className='sem-light';}
        goEl.style.display='block';
        setTimeout(()=>{sem.classList.add('hidden');onGo();},700);
      },900);}
    },400);
  }
  ...
  const DURATION=5000;
  function trackW(){const t=document.getElementById('race-track');return t?t.offsetWidth-190-100:600;}
  function posForFR(fr,w){return ((fr-0.70)/(1.0-0.70))*w*0.78;}

  function renderFrame(prog) {
    const w=trackW(); const curFRs={};
    RACERS.forEach(r=>{
      const p=Math.min(prog,1);
      const eased=p<0.5?2*p*p:1-Math.pow(-2*p+2,2)/2;
      const curPos=posForFR(r.fr,w)*eased;
      ...
      if(frLbl)frLbl.textContent=(curFR*100).toFixed(1).replace('.', ',')+'%';
    });
  ...
  function animate(ts){
    ...
    const delta=(ts-lastTime)*speed; lastTime=ts;
    progress+=delta/DURATION;
    if(progress>=1){progress=1;running=false;renderFrame(1);const pb=document.getElementById('rc-play');if(pb)pb.innerHTML='&#9654;';return;}
    renderFrame(progress);
    if(running)rafId=requestAnimationFrame(animate);
  }

  function startRace(){running=true;lastTime=null;rafId=requestAnimationFrame(animate);}

  window.raceToggle=function(){
    if(progress>=1){progress=0;renderFrame(0);}
    if(!running){runSemaforo(startRace);}
    else{running=false;cancelAnimationFrame(rafId);const pb=document.getElementById('rc-play');if(pb)pb.innerHTML='&#9654;';}
  };
  window.raceReset=function(){
    running=false;cancelAnimationFrame(rafId);progress=0;renderFrame(0);
    const pb=document.getElementById('rc-play');if(pb)pb.innerHTML='&#9654;';
    const sem=document.getElementById('semaforo');if(sem)sem.classList.add('hidden');
  };
  window.raceSetSpeed=function(s){
    speed=s;
    ['1x','2x','5x'].forEach(id=>{const b=document.getElementById('rc-'+id);if(b)b.classList.toggle('rc-active',id===s+'x');});
  };
...
function init() {
  ...
  document.getElementById('kpi-andina-fr').textContent = fmtP(frA);
  document.getElementById('kpi-embonor-fr').textContent = fmtP(frE);
  document.getElementById('kpi-chile-fr').textContent = fmtP(frC);
}
